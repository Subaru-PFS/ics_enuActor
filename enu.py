KeysDictionary('enu', (1, 8),
               ...
               Key("shutters",
                   Enum('LOADING', 'LOADED', 'INITIALISING', 'IDLE', 'BUSY', 'FAILED', name='fsm',
                        help='state machine'),
                   Enum('simulation', 'operation', name='mode', help='current mode'),
                   Enum('close', 'open', name='position', help='shutters current position')),
		   String(name='datetime', help='ISO formatted datetime'))
               Key("shb",
                   Enum('close', 'open', name='open', help='blue shutter open bit'),
                   Enum('open', 'close', name='close', help='blue shutter close bit'),
                   Enum('ok', 'error', name='position', help='blue shutter error bit')),
               Key("shr",
                   Enum('close', 'open', name='open', help='red shutter open bit'),
                   Enum('open', 'close', name='close', help='red shutter close bit'),
                   Enum('ok', 'error', name='position', help='red shutter error bit')),

               Key("bia",
                   Enum('LOADING', 'LOADED', 'INITIALISING', 'IDLE', 'BUSY', 'FAILED', name='fsm',
                        help='state machine'),
                   Enum('simulation', 'operation', name='mode', help='current mode'),
                   Enum('off', 'on', name='position', help='bia current state')),
               Key("biaConfig",
               ...
               Key("rexm",
                   Enum('LOADING', 'LOADED', 'INITIALISING', 'IDLE', 'BUSY', 'FAILED', name='fsm',
                        help='state machine'),
                   Enum('simulation', 'operation', name='mode', help='current mode'),
                   Enum('low', 'mid', name='position', help='rexm current position')),
               Key("rexmInfo",
                   Float(name='motors', help='motors position')),
