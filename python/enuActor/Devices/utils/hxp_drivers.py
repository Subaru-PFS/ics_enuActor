...
class XPS:
	...
	def GroupReadyAtPosition (self, socketId, GroupName, EncoderPosition1, EncoderPosition2, EncoderPosition3, EncoderPosition4, EncoderPosition5, EncoderPosition6):
		...
		command = 'GroupReadyAtPosition(' + GroupName + ',' + str(EncoderPosition1) + ',' + str(EncoderPosition2) + ',' + str(EncoderPosition3) + ',' + str(EncoderPosition4) + ',' + str(EncoderPosition5) + ',' + str(EncoderPosition6) + ')'
	...
	def PositionerSGammaParametersDistanceGet (self, socketId, PositionerName, Displacement, Velocity, Acceleration, MinJerkTime, MaxJerkTime):
		...
		command = 'PositionerSGammaParametersDistanceGet(' + PositionerName + ',' + str(Displacement) + ',' + str(Velocity) + ',' + str(Acceleration) + ',' + str(MinJerkTime) + ',' + str(MaxJerkTime) + ',double *,double *)'
	...
	def HexapodMoveIncrementalControl (self, socketId, GroupName, CoordinateSystem, HexapodTrajectoryType, dX, dY, dZ):
		...
		command = 'HexapodMoveIncrementalControl(' + GroupName + ',' + CoordinateSystem + ',' + HexapodTrajectoryType + ',' + str(dX) + ',' + str(dY) + ',' + str(dZ) + ')'
	...
	def HexapodMoveIncrementalControlWithTargetVelocity (self, socketId, GroupName, CoordinateSystem, HexapodTrajectoryType, dX, dY, dZ, Velocity):
		...
		command = 'HexapodMoveIncrementalControlWithTargetVelocity(' + GroupName + ',' + CoordinateSystem + ',' + HexapodTrajectoryType + ',' + str(dX) + ',' + str(dY) + ',' + str(dZ) + ',' + str(Velocity) + ')'
	...
	def HexapodMoveIncrementalControlLimitGet (self, socketId, GroupName, CoordinateSystem, HexapodTrajectoryType, dX, dY, dZ):
		...
		command = 'HexapodMoveIncrementalControlLimitGet(' + GroupName + ',' + CoordinateSystem + ',' + HexapodTrajectoryType + ',' + str(dX) + ',' + str(dY) + ',' + str(dZ) + ',double *,double *)'
	...
	def HexapodSGammaParametersDistanceGet (self, socketId, PositionerName, Displacement, Velocity, Acceleration, MinJerkTime, MaxJerkTime):
		...
		command = 'HexapodSGammaParametersDistanceGet(' + PositionerName + ',' + str(Displacement) + ',' + str(Velocity) + ',' + str(Acceleration) + ',' + str(MinJerkTime) + ',' + str(MaxJerkTime) + ',double *,double *)'
